              ...
              children: [
                ...
                OutlinedButton.icon(
                  ...
                  style: OutlinedButton.styleFrom(
                    ...
                    side: const BorderSide(color: AgroTheme.errorRed, width: 1.5),
  ...
  Widget _buildProfileHeader(String name, String dni) {
    return Column(
      children: [
        ...
        Text(
          'DNI: $dni',
          style: const TextStyle(color: AgroTheme.textMuted, fontSize: 14, fontWeight: FontWeight.w500),
        ),
        ...
        Container(
          ...
          child: Row(
            ...
            children: const [
              Icon(Icons.verified_rounded, color: AgroTheme.primaryGreen, size: 16),
              SizedBox(width: 8),
              Text(
                'Socio Verificado',
                style: TextStyle(
  ...
  Widget _buildSectionCard({required List<_ProfileItem> items}) {
    return GlassCard(
      ...
      child: ListView.separated(
        ...
        separatorBuilder: (context, index) => Divider(height: 1, color: Colors.white.withOpacity(0.15), indent: 56),
        itemBuilder: (context, index) => Material(
          ...
          child: ListTile(
            ...
            title: Text(
              items[index].title,
              style: const TextStyle(fontWeight: FontWeight.w600, color: AgroTheme.textDark, fontSize: 14),
            ),
            subtitle: items[index].subtitle != null
                ? Text(items[index].subtitle!, style: const TextStyle(color: AgroTheme.textMuted, fontSize: 12, fontWeight: FontWeight.w500))
                : null,
            trailing: Icon(items[index].trailing ?? Icons.chevron_right_rounded, color: AgroTheme.textMuted),
            onTap: () {},
          ),
        ),
      ),
